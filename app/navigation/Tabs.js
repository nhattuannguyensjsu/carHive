...
const Tabs = () => {
  return (
    <Tab.Navigator screenOptions={{
        ...
        <Tab.Screen name="InboxPage" component={InboxPage} options={{
          tabBarIcon: ({focused}) => (
        ...
        <Tab.Screen name="MyListingPage" component={MyListingPage} options={{
          tabBarIcon: ({focused}) => (
            <View style={{alignItems: 'center'}}>
              <Image 
        ...
        <Tab.Screen name="PostPage" component={PostPage} options={{
          tabBarIcon: ({focused}) => (
            <View style={{alignItems: 'center'}}>
